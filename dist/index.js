  ...
  "node_modules/graphql/type/definition.js"(exports) {
    ...
    var GraphQLScalarType = /* @__PURE__ */ function() {
      function GraphQLScalarType2(config3) {
        ...
        this.parseLiteral = (_config$parseLiteral = config3.parseLiteral) !== null && _config$parseLiteral !== void 0 ? _config$parseLiteral : function(node, variables) {
    ...
    function defineTypes(config3) {
      var types = resolveThunk(config3.types);
      Array.isArray(types) || (0, _devAssert.default)(0, "Must provide Array of types or a function which returns such an array for Union ".concat(config3.name, "."));
      return types;
    }
  ...
  "node_modules/graphql/utilities/lexicographicSortSchema.js"(exports) {
    ...
    function lexicographicSortSchema(schema) {
      ...
      function sortDirective(directive) {
        var config3 = directive.toConfig();
        return new _directives.GraphQLDirective(_objectSpread(_objectSpread({}, config3), {}, {
          locations: sortBy(config3.locations, function(x) {
            return x;
          }),
...
var require_match = __commonJS({
  "src/vite/match.ts"(exports, module2) {
    ...
    var getComponents2 = (config3, tags) => {
...
var require_main2 = __commonJS({
  "node_modules/dotenv/lib/main.js"(exports, module2) {
    ...
    function config3(options) {
      ...
      try {
        const parsed = parse3(fs3.readFileSync(dotenvPath, { encoding }), { debug });
...
var convertPath = (config3) => {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
  const result = {};
  if (config3.atoms) {
    result.atoms = convertComponentPath(config3.atoms, ((_a = config3.root) == null ? void 0 : _a.components) || "");
  }
  if (config3.molecules) {
    result.molecules = convertComponentPath(config3.molecules, ((_b = config3.root) == null ? void 0 : _b.components) || "");
  }
  if (config3.organisms) {
    result.organisms = convertComponentPath(config3.organisms, ((_c = config3.root) == null ? void 0 : _c.components) || "");
  }
  if (config3.templates) {
    result.templates = convertComponentPath(config3.templates, ((_d = config3.root) == null ? void 0 : _d.components) || "");
  }
  if (config3.pages) {
    result.pages = convertComponentPath(config3.pages, ((_e = config3.root) == null ? void 0 : _e.components) || "");
  }
  if (config3.loaders) {
    result.loaders = convertComponentPath(config3.loaders, ((_f = config3.root) == null ? void 0 : _f.components) || "");
  }
  if (config3.extensions) {
    result.extensions = convertComponentPath(config3.extensions, ((_g = config3.root) == null ? void 0 : _g.components) || "");
  }
  if (config3.store) {
    result.store = {};
    for (const key in config3.store) {
      let storeResult = {};
      if (!config3.store[key].module) {
        storeResult = config3.store[key];
      } else {
        if (typeof config3.store[key].module === "string") {
          if (checkPath(config3.store[key].module)) {
            storeResult = __spreadProps(__spreadValues({}, config3.store[key]), {
              module: {
                type: "full",
                path: config3.store[key].module
              }
            });
          } else if (checkPath(((_h = config3 == null ? void 0 : config3.root) == null ? void 0 : _h.store) + "/" + config3.store[key].module)) {
            storeResult = __spreadProps(__spreadValues({}, config3.store[key]), {
              module: {
                type: "full",
                path: ((_i = config3 == null ? void 0 : config3.root) == null ? void 0 : _i.store) + "/" + config3.store[key].module
              }
            });
          } else {
            storeResult = __spreadProps(__spreadValues({}, config3.store[key]), {
              module: {
                type: "inside",
                path: ((_j = config3 == null ? void 0 : config3.root) == null ? void 0 : _j.store) || "",
                component: config3.store[key].module
              }
            });
          }
        }
  ...
  if (config3.locales) {
    result.locales = {};
    for (const key in config3.locales) {
      result.locales[key] = [];
      const locale = config3.locales[key];
      for (const key2 in locale) {
        ...
        if (typeof locale2 === "string") {
          ...
          } else if (checkPath(((_k = config3 == null ? void 0 : config3.root) == null ? void 0 : _k.locales) + "/" + locale2)) {
            result.locales[key].push({
              type: "full",
              path: ((_l = config3 == null ? void 0 : config3.root) == null ? void 0 : _l.locales) + "/" + locale2
            });
          } else {
            result.locales[key].push({
              type: "inside",
              path: ((_m = config3.root) == null ? void 0 : _m.locales) || "",
              component: locale2
            });
          }
        }
...
var cloneConfig = (config3) => {
  return JSON.parse(JSON.stringify(config3));
};
var setupConfig_default = (rootDir) => {
  ...
  let config3 = cloneConfig(themeConfig);
  config3 = __spreadValues(__spreadValues({}, config3), convertPath(config3));
  if (typeof config3.app !== "undefined") {
    for (const key in config3.app) {
      delete require.cache[require.resolve(config3.app[key])];
      const customAppConfig = require(config3.app[key]).default;
  ...
  if (typeof config3.theme !== "undefined") {
    delete require.cache[require.resolve(config3.theme)];
    const customThemeConfig = require(config3.theme).default;
  ...
  themeOptions = _.mergeWith(themeOptions, config3, mergeConfig);
  return themeOptions;
};

// src/setupRoutes.ts
var _2 = __toModule(require_lodash());
var convertComponent = (component, config3) => {
  if (config3.pages[component].type === "full") {
    return `import('${config3.pages[component].path}').then((m) => {
    ...
    return `import('${config3.pages[component].path}').then((m) => {
      let component = m.${config3.pages[component].component}
...
var setupRoutes_default = (config3) => {
  let whiteList = [];
  let exclude = [];
  let routes = [];
  for (const url in config3.seo) {
    const pageComponent = config3.seo[url];
    ...
    routes.push({
      ...
      path: url,
      component: convertComponent(pageComponent.component, config3)
    });
    if (!_2.isUndefined(pageComponent.seo) && !_2.isEmpty(result)) {
      for (const urlKey in result) {
        if (result[urlKey].url !== "") {
          ...
          } else if (_2.isUndefined(pageComponent.generate)) {
            whiteList = [
              ...whiteList,
              result[urlKey].url
            ];
...
var setupImages_default = (config3) => {
  let result = {};
  for (const key in config3.image) {
    const image = config3.image[key];
    result[key] = {};
...
var extract_default = (template2, filename, config3) => {
  ...
  return {
    components: getComponents(config3, [...result.ast.components])
  };
};
...
var getImport = (name, type, config3, tag, renderImport2) => {
  let comImport = false;
  switch (type) {
    case "A":
      if (!config3.atoms[name]) {
        return;
      }
      comImport = renderImport2(config3.atoms[name], tag);
      break;
    case "M":
      if (!config3.molecules[name]) {
        return;
      }
      comImport = renderImport2(config3.molecules[name], tag);
      break;
    case "O":
      if (!config3.organisms[name]) {
        return;
      }
      comImport = renderImport2(config3.organisms[name], tag);
      break;
    case "T":
      if (!config3.templates[name]) {
        return;
      }
      comImport = renderImport2(config3.templates[name], tag);
      break;
    case "L":
      if (!config3.loaders[name]) {
        return;
      }
      comImport = renderImport2(config3.loaders[name], tag);
      break;
    case "E":
      if (!config3.extensions[name]) {
        return;
      }
      comImport = renderImport2(config3.extensions[name], tag);
      break;
  }
  return comImport;
};
var transform_default = (code, components = [], config3) => {
  const imports = [];
  for (const tag of components) {
    ...
    const type = m[1];
    const name = m[2];
    let comImport = getImport(name, type, config3, tag, renderImport);
    let comImportCss = getImport(name, type, config3, tag, renderImportCss);
...
// src/vuefront-resolver.ts
var config = setupConfig_default(process.cwd());
var resolveComponent = (name, type, tag) => {
  let comImport = false;
  switch (type) {
    case "A":
...
var extractAndTransform = (code, template2 = "", descriptor, config3) => {
  if (typeof template2 !== "string" || !template2.trim()) {
    return code;
  }
  const { components } = extract_default(template2, descriptor.filename, config3);
  return transform_default(code, components, config3);
};
function pluginVueFront(options = {}) {
  ...
  return {
    ...
    load(id) {
      if (id === vuefrontCreateAppId) {
        const routesContent = fs2.readFileSync(path2.resolve(__dirname, "../templates/create-app.js"));
      ...
      if (id === vuefrontRoutesId) {
        const routesContent = fs2.readFileSync(path2.resolve(__dirname, "../templates/routes.js"));
        let compiled = _4.template(routesContent.toString());
        return compiled({ options: { routes } });
      }
      if (id === vuefrontPluginId) {
        const pluginContent = fs2.readFileSync(path2.resolve(__dirname, "../templates/plugin.js"));
